...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*create-story" workflow="/Users/martinjanci/cursor/phone-manager-backend/bmad/bmm/workflows/4-implementation/create-story/workflow.yaml">Create Development Story</item>
    <item cmd="*dev-story" workflow="/Users/martinjanci/cursor/phone-manager-backend/bmad/bmm/workflows/4-implementation/dev-story/workflow.yaml">Implement Story with Context</item>
    <item cmd="*review-story" workflow="/Users/martinjanci/cursor/phone-manager-backend/bmad/bmm/workflows/4-implementation/review-story/workflow.yaml">Review Story Implementation</item>
    <item cmd="*retro" workflow="/Users/martinjanci/cursor/phone-manager-backend/bmad/bmm/workflows/4-implementation/retrospective/workflow.yaml">Sprint Retrospective</item>
